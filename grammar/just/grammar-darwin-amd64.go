...
func assert_valid_token(tls *libc.TLS, sym TSSymbol) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	if libc.BoolInt64(!(libc.Int32FromUint16(sym) >= int32(INDENT) && libc.Int32FromUint16(sym) < int32(TOKEN_TYPE_END))) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, __ccgo_ts+17, int32(76)))
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+28, libc.VaList(bp+8, libc.Int32FromUint16(sym)))
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+46, 0)
...
func tree_sitter_just_external_scanner_create(tls *libc.TLS) (r uintptr) {
	...
	if libc.BoolInt64(!(ptr != 0)) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, __ccgo_ts+17, int32(91)))
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+48, 0)
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+46, 0)
		libc.Xexit(tls, int32(1))
	}
	return ptr
...
func tree_sitter_just_external_scanner_destroy(tls *libc.TLS, payload uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	if libc.BoolInt64(!(payload != 0)) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, __ccgo_ts+17, int32(100)))
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+104, 0)
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+46, 0)
		libc.Xexit(tls, int32(1))
	}
...
func tree_sitter_just_external_scanner_serialize(tls *libc.TLS, payload uintptr, buffer uintptr) (r uint32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	if libc.BoolInt64(!(libc.Uint64FromInt64(8) < libc.Uint64FromInt32(TREE_SITTER_SERIALIZATION_BUFFER_SIZE))) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, __ccgo_ts+17, int32(109)))
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+132, 0)
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+46, 0)
		libc.Xexit(tls, int32(1))
	}
	libc.X__builtin___memcpy_chk(tls, buffer, payload, uint64(8), ^__predefined_size_t(0))
	return uint32(8)
}
...
func tree_sitter_just_external_scanner_deserialize(tls *libc.TLS, payload uintptr, buffer uintptr, length uint32) {
	...
	libc.X__builtin___memcpy_chk(tls, ptr, buffer, uint64(8), ^__predefined_size_t(0))
}
...
func handle_eof(tls *libc.TLS, lexer uintptr, state uintptr, valid_symbols uintptr) (r uint8) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	if libc.BoolInt64(!((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0)) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, __ccgo_ts+17, int32(138)))
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+153, 0)
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+46, 0)
		libc.Xexit(tls, int32(1))
	}
...
func tree_sitter_just_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	var v4 uint64
	var v19 bool
	_, _, _, _, _, _, _, _, _, _, _, _ = advanced_once, eol_found, escape, indent, scanner, v1, v19, v3, v4, v5, v7, v8
	scanner = payload
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(INDENT))) != 0 || *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(DEDENT))) != 0 {
		for {
			if v19 = !((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0); v19 {
				v3 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead
				v4 = uint64(0x00004000)
				v8 = libc.BoolInt32(v3 & ^libc.Int32FromInt32(0x7F) == 0)
				goto _18
