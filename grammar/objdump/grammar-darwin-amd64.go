...
func scan_code_identifier(tls *libc.TLS, lexer uintptr) (r uint8) {
	...
	var v4 uint64
	_, _, _, _, _, _, _, _, _, _, _, _, _, _ = has_hexadecimal_data, has_text, next_token_text, offset_counter, possibly_in_next_file_offset_token, possibly_in_next_hexadecimal_token, size, v1, v10, v3, v4, v5, v7, v8
	...
	for int32(true1) != 0 {
		...
		if v10 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead != int32('\n'); v10 {
