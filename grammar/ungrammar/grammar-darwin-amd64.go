...
const anon_sym_STAR = 5
const anon_sym_QMARK = 6
const anon_sym_SQUOTE = 7
const anon_sym_COLON = 8
const anon_sym_PIPE = 9
const sym_token_identifier = 10
const sym_comment = 11
const sym_grammar = 12
const sym_node = 13
const sym_rule = 14
const sym__atom_rule = 15
const sym_repetition = 16
const sym_optional = 17
const sym_node_rule = 18
const sym_token = 19
const sym_label = 20
const sym_sequence = 21
const sym_alternation = 22
const aux_sym_grammar_repeat1 = 23
const aux_sym_sequence_repeat1 = 24
const aux_sym_alternation_repeat1 = 25
const alias_sym_definition = 26
const alias_sym_label_name = 27

var ts_symbol_names = [28]uintptr{
	0:  __ccgo_ts,
	1:  __ccgo_ts + 4,
	2:  __ccgo_ts + 15,
	3:  __ccgo_ts + 17,
...
var ts_symbol_map = [28]TSSymbol{
	1:  uint16(sym_identifier),
	2:  uint16(anon_sym_EQ),
	3:  uint16(anon_sym_LPAREN),
	4:  uint16(anon_sym_RPAREN),
	5:  uint16(anon_sym_STAR),
	6:  uint16(anon_sym_QMARK),
	7:  uint16(anon_sym_SQUOTE),
	8:  uint16(anon_sym_COLON),
	9:  uint16(anon_sym_PIPE),
	10: uint16(sym_token_identifier),
	11: uint16(sym_comment),
	12: uint16(sym_grammar),
	13: uint16(sym_node),
	14: uint16(sym_rule),
	15: uint16(sym__atom_rule),
	16: uint16(sym_repetition),
	17: uint16(sym_optional),
	18: uint16(sym_node_rule),
	19: uint16(sym_token),
	20: uint16(sym_label),
	21: uint16(sym_sequence),
	22: uint16(sym_alternation),
	23: uint16(aux_sym_grammar_repeat1),
	24: uint16(aux_sym_sequence_repeat1),
	25: uint16(aux_sym_alternation_repeat1),
	26: uint16(alias_sym_definition),
	27: uint16(alias_sym_label_name),
}

var ts_symbol_metadata = [28]TSSymbolMetadata{
	0: {
...
var ts_alias_sequences = [3][3]TSSymbol{
	0: {},
	1: {
		0: uint16(alias_sym_definition),
	},
	2: {
		0: uint16(alias_sym_label_name),
	},
}
...
start:
	...
	case int32(14):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(sym_token_identifier)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if lookahead == int32('\n') {
			state = uint16(17)
			goto next_state
...
var ts_parse_table = [5][26]uint16_t{
	0: {
		0:  uint16(1),
		1:  uint16(1),
		2:  uint16(1),
...
var ts_small_parse_table = [407]uint16_t{
	...
	13:  uint16(3),
	14:  uint16(1),
	15:  uint16(aux_sym_sequence_repeat1),
	16:  uint16(26),
	17:  uint16(2),
	19:  uint16(anon_sym_PIPE),
	20:  uint16(11),
	21:  uint16(6),
	22:  uint16(sym__atom_rule),
	23:  uint16(sym_repetition),
	24:  uint16(sym_optional),
	25:  uint16(sym_node_rule),
	26:  uint16(sym_token),
	27:  uint16(sym_label),
	28:  uint16(7),
	29:  uint16(3),
	...
	35:  uint16(11),
	36:  uint16(1),
	37:  uint16(anon_sym_LPAREN),
	38:  uint16(13),
	39:  uint16(1),
	40:  uint16(anon_sym_SQUOTE),
	41:  uint16(3),
	42:  uint16(1),
	43:  uint16(aux_sym_sequence_repeat1),
	44:  uint16(26),
	45:  uint16(2),
	46:  uint16(anon_sym_RPAREN),
	47:  uint16(anon_sym_PIPE),
	48:  uint16(11),
	49:  uint16(6),
	50:  uint16(sym__atom_rule),
	51:  uint16(sym_repetition),
	52:  uint16(sym_optional),
	53:  uint16(sym_node_rule),
	54:  uint16(sym_token),
	55:  uint16(sym_label),
	56:  uint16(7),
	57:  uint16(3),
	58:  uint16(1),
	59:  uint16(sym_comment),
	60:  uint16(9),
	61:  uint16(1),
	62:  uint16(sym_identifier),
	63:  uint16(11),
	64:  uint16(1),
	65:  uint16(anon_sym_LPAREN),
	66:  uint16(13),
	67:  uint16(1),
	68:  uint16(anon_sym_SQUOTE),
	69:  uint16(5),
	70:  uint16(1),
	71:  uint16(aux_sym_sequence_repeat1),
	72:  uint16(21),
	73:  uint16(1),
	74:  uint16(sym_sequence),
	75:  uint16(11),
	76:  uint16(6),
	77:  uint16(sym__atom_rule),
	78:  uint16(sym_repetition),
	79:  uint16(sym_optional),
	80:  uint16(sym_node_rule),
	81:  uint16(sym_token),
	82:  uint16(sym_label),
	83:  uint16(7),
	84:  uint16(3),
	...
	87:  uint16(9),
	88:  uint16(1),
	89:  uint16(sym_identifier),
	90:  uint16(11),
	91:  uint16(1),
	92:  uint16(anon_sym_LPAREN),
	93:  uint16(13),
	94:  uint16(1),
	95:  uint16(anon_sym_SQUOTE),
	96:  uint16(6),
	97:  uint16(1),
	98:  uint16(aux_sym_sequence_repeat1),
	99:  uint16(21),
	100: uint16(1),
	101: uint16(sym_sequence),
	102: uint16(11),
	103: uint16(6),
	104: uint16(sym__atom_rule),
	105: uint16(sym_repetition),
	106: uint16(sym_optional),
	107: uint16(sym_node_rule),
	108: uint16(sym_token),
	109: uint16(sym_label),
	110: uint16(5),
	111: uint16(3),
	112: uint16(1),
	...
	114: uint16(9),
	115: uint16(1),
	116: uint16(sym_identifier),
	117: uint16(11),
	118: uint16(1),
	119: uint16(anon_sym_LPAREN),
	120: uint16(13),
	121: uint16(1),
	122: uint16(anon_sym_SQUOTE),
	123: uint16(16),
	124: uint16(6),
	125: uint16(sym__atom_rule),
	126: uint16(sym_repetition),
	127: uint16(sym_optional),
	128: uint16(sym_node_rule),
	129: uint16(sym_token),
	130: uint16(sym_label),
	131: uint16(3),
	132: uint16(3),
	133: uint16(1),
	134: uint16(sym_comment),
	135: uint16(33),
	136: uint16(1),
	137: uint16(anon_sym_COLON),
	138: uint16(31),
	139: uint16(8),
	141: uint16(anon_sym_LPAREN),
	142: uint16(anon_sym_RPAREN),
	143: uint16(anon_sym_STAR),
	144: uint16(anon_sym_QMARK),
	145: uint16(anon_sym_SQUOTE),
	146: uint16(anon_sym_PIPE),
	...
	152: uint16(37),
	153: uint16(1),
	154: uint16(anon_sym_STAR),
	155: uint16(39),
	156: uint16(1),
	157: uint16(anon_sym_QMARK),
	158: uint16(35),
	159: uint16(6),
	161: uint16(anon_sym_LPAREN),
	162: uint16(anon_sym_RPAREN),
	163: uint16(anon_sym_SQUOTE),
	164: uint16(anon_sym_PIPE),
	165: uint16(sym_identifier),
	166: uint16(2),
	167: uint16(3),
	168: uint16(1),
	169: uint16(sym_comment),
	170: uint16(41),
	171: uint16(8),
	173: uint16(anon_sym_LPAREN),
	174: uint16(anon_sym_RPAREN),
	175: uint16(anon_sym_STAR),
	176: uint16(anon_sym_QMARK),
	177: uint16(anon_sym_SQUOTE),
	178: uint16(anon_sym_PIPE),
	179: uint16(sym_identifier),
	180: uint16(2),
	181: uint16(3),
	182: uint16(1),
	...
	184: uint16(43),
	185: uint16(8),
	187: uint16(anon_sym_LPAREN),
	188: uint16(anon_sym_RPAREN),
	189: uint16(anon_sym_STAR),
	190: uint16(anon_sym_QMARK),
	191: uint16(anon_sym_SQUOTE),
	192: uint16(anon_sym_PIPE),
	...
	203: uint16(anon_sym_STAR),
	204: uint16(anon_sym_QMARK),
	205: uint16(anon_sym_SQUOTE),
	206: uint16(anon_sym_PIPE),
	207: uint16(sym_identifier),
	208: uint16(2),
	209: uint16(3),
	210: uint16(1),
	211: uint16(sym_comment),
	212: uint16(47),
	213: uint16(8),
	215: uint16(anon_sym_LPAREN),
	216: uint16(anon_sym_RPAREN),
	217: uint16(anon_sym_STAR),
	218: uint16(anon_sym_QMARK),
	219: uint16(anon_sym_SQUOTE),
	220: uint16(anon_sym_PIPE),
	221: uint16(sym_identifier),
	222: uint16(2),
	223: uint16(3),
	224: uint16(1),
	...
	232: uint16(anon_sym_QMARK),
	233: uint16(anon_sym_SQUOTE),
	234: uint16(anon_sym_PIPE),
	235: uint16(sym_identifier),
	236: uint16(4),
	237: uint16(3),
	238: uint16(1),
	239: uint16(sym_comment),
	240: uint16(53),
	241: uint16(1),
	242: uint16(anon_sym_PIPE),
	243: uint16(20),
	244: uint16(1),
	245: uint16(aux_sym_alternation_repeat1),
	246: uint16(51),
	247: uint16(2),
	249: uint16(sym_identifier),
	250: uint16(4),
	251: uint16(3),
	252: uint16(1),
	...
	261: uint16(2),
	262: uint16(sym_node),
	263: uint16(aux_sym_grammar_repeat1),
	264: uint16(4),
	265: uint16(3),
	266: uint16(1),
	...
	271: uint16(59),
	272: uint16(1),
	273: uint16(sym_identifier),
	274: uint16(19),
	275: uint16(2),
	276: uint16(sym_node),
	277: uint16(aux_sym_grammar_repeat1),
	278: uint16(4),
	279: uint16(3),
	280: uint16(1),
	...
	285: uint16(22),
	286: uint16(1),
	287: uint16(aux_sym_alternation_repeat1),
	288: uint16(62),
	289: uint16(2),
	291: uint16(sym_identifier),
	292: uint16(2),
	293: uint16(3),
	294: uint16(1),
	...
	300: uint16(anon_sym_PIPE),
	301: uint16(sym_identifier),
	302: uint16(4),
	303: uint16(3),
	304: uint16(1),
	...
	309: uint16(22),
	310: uint16(1),
	311: uint16(aux_sym_alternation_repeat1),
	312: uint16(64),
	313: uint16(2),
	...
	317: uint16(3),
	318: uint16(1),
	319: uint16(sym_comment),
	320: uint16(69),
	321: uint16(3),
	323: uint16(anon_sym_RPAREN),
	324: uint16(sym_identifier),
	325: uint16(4),
	326: uint16(3),
	327: uint16(1),
	328: uint16(sym_comment),
	329: uint16(62),
	330: uint16(1),
	331: uint16(anon_sym_RPAREN),
	332: uint16(71),
	333: uint16(1),
	334: uint16(anon_sym_PIPE),
	335: uint16(25),
	336: uint16(1),
	337: uint16(aux_sym_alternation_repeat1),
	338: uint16(4),
	339: uint16(3),
	340: uint16(1),
	...
	345: uint16(73),
	346: uint16(1),
	347: uint16(anon_sym_PIPE),
	348: uint16(25),
	349: uint16(1),
	350: uint16(aux_sym_alternation_repeat1),
	351: uint16(4),
	352: uint16(3),
	353: uint16(1),
	354: uint16(sym_comment),
	355: uint16(51),
	356: uint16(1),
	357: uint16(anon_sym_RPAREN),
	358: uint16(71),
	359: uint16(1),
	360: uint16(anon_sym_PIPE),
	361: uint16(24),
	362: uint16(1),
	363: uint16(aux_sym_alternation_repeat1),
	364: uint16(2),
	365: uint16(3),
	366: uint16(1),
	...
	368: uint16(76),
	369: uint16(2),
	371: uint16(sym_identifier),
	372: uint16(2),
	373: uint16(78),
	374: uint16(1),
	375: uint16(sym_token_identifier),
	376: uint16(80),
	377: uint16(1),
	...
	397: uint16(86),
	398: uint16(1),
	399: uint16(anon_sym_RPAREN),
	400: uint16(2),
	401: uint16(3),
	402: uint16(1),
	403: uint16(sym_comment),
	404: uint16(88),
	405: uint16(1),
}

var ts_small_parse_table_map = [28]uint32_t{
	1:  uint32(28),
	2:  uint32(56),
	3:  uint32(83),
	4:  uint32(110),
...
var ts_parse_actions = [90]TSParseActionEntry{
	0: {},
	...
	58: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Ftype_token:  uint8(TSParseActionTypeReduce),
		Fchild_count: uint8(2),
		Fsymbol:      uint16(aux_sym_grammar_repeat1),
	})))),
...
func tree_sitter_ungrammar(tls *libc.TLS) (r uintptr) {
...
var __ccgo_ts1 = "end\x00identifier\x00=\x00(\x00)\x00*\x00?\x00'\x00:\x00|\x00token_identifier\x00comment\x00grammar\x00node\x00rule\x00_atom_rule\x00repetition\x00optional\x00node_rule\x00token\x00label\x00sequence\x00alternation\x00grammar_repeat1\x00sequence_repeat1\x00alternation_repeat1\x00definition\x00label_name\x00"
