// Code generated for linux/386 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions -std=gnu11 -O0 -Dfunc=func_token -Dinterface=interface_token -Dselect=select_token -Dchan=chan_token -Dgo=go_token -Dmap=map_token -Dpackage=package_token -Dtype=type_token -Dvar=var_token -Dimport=import_token -Ddefer=defer_token -Dfallthrough=fallthrough_token -Drange=range_token -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-xml/dtd/src -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-xml/dtd -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-xml -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/include -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/src combined.c -o grammar.go', DO NOT EDIT.
...
const STATE_COUNT = 334
const SUPERTYPE_COUNT = 0
const SYMBOL_COUNT = 111
...
func scan_pi_target(tls *libc.TLS, lexer1 uintptr, valid_symbols uintptr) (r uint8) {
	var advanced_once, found_x_first, v2 uint8
	var v1 wchar_t
	var v4 uintptr
	_, _, _, _, _ = advanced_once, found_x_first, v1, v2, v4
...
_3:
	if v2 != 0 {
		if (*TSLexer)(unsafe.Pointer(lexer1)).Flookahead == int32('x') || (*TSLexer)(unsafe.Pointer(lexer1)).Flookahead == int32('X') {
	...
	if advanced_once != 0 {
		...
		_7:
			...
			if found_x_first != 0 && ((*TSLexer)(unsafe.Pointer(lexer1)).Flookahead == int32('m') || (*TSLexer)(unsafe.Pointer(lexer1)).Flookahead == int32('M')) {
				v4 = lexer1
				(*(*func(*libc.TLS, uintptr, uint8))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(v4)).Fadvance})))(tls, v4, libc.BoolUint8(false1 != 0))
				if (*TSLexer)(unsafe.Pointer(lexer1)).Flookahead == int32('l') || (*TSLexer)(unsafe.Pointer(lexer1)).Flookahead == int32('L') {
					v4 = lexer1
					(*(*func(*libc.TLS, uintptr, uint8))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(v4)).Fadvance})))(tls, v4, libc.BoolUint8(false1 != 0))
					v1 = (*TSLexer)(unsafe.Pointer(lexer1)).Flookahead
					v2 = libc.BoolUint8(libc.Xiswalnum(tls, libc.Uint32FromInt32(v1)) != 0 || v1 == int32('_') || v1 == int32(':') || v1 == int32('.') || v1 == int32('-') || v1 == int32(0xB7))
		...
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer1)).Fmark_end})))(tls, lexer1)
		(*TSLexer)(unsafe.Pointer(lexer1)).Fresult_symbol = uint16(PI_TARGET)
...
func tree_sitter_dtd_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer1 uintptr, valid_symbols uintptr) (r uint8) {
	var v1 uintptr
	_ = v1
...
start:
	...
	case 0:
		...
		i = uint32(0)
		for {
			if !(i < libc.Uint32FromInt64(124)/libc.Uint32FromInt64(2)) {
				break
			}
	...
	case int32(39):
		...
		i2 = uint32(0)
		for {
			if !(i2 < libc.Uint32FromInt64(88)/libc.Uint32FromInt64(2)) {
				break
			}
...
start:
	...
	case 0:
		i = uint32(0)
		for {
			if !(i < libc.Uint32FromInt64(40)/libc.Uint32FromInt64(2)) {
				break
			}
...
func init() {
	...
	*(*uintptr)(unsafe.Add(p, 112)) = __ccgo_fp(tree_sitter_dtd_external_scanner_create)
	*(*uintptr)(unsafe.Add(p, 116)) = __ccgo_fp(tree_sitter_dtd_external_scanner_destroy)
	*(*uintptr)(unsafe.Add(p, 120)) = __ccgo_fp(tree_sitter_dtd_external_scanner_scan)
	*(*uintptr)(unsafe.Add(p, 124)) = __ccgo_fp(tree_sitter_dtd_external_scanner_serialize)
	*(*uintptr)(unsafe.Add(p, 128)) = __ccgo_fp(tree_sitter_dtd_external_scanner_deserialize)
}
