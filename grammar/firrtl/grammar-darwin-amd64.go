...
func tree_sitter_firrtl_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	var indent_length, v4 uint32_t
	var scanner, tmp, v5 uintptr
	var v2 uint32
	_, _, _, _, _, _, _, _ = current_indent_length, found_end_of_line, indent_length, scanner, tmp, v2, v4, v5
	scanner = payload
		...
		if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 > uint32(0) {
			...
			if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(INDENT))) != 0 && indent_length > uint32(current_indent_length) {
				if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fcap1 == (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 {
					...
					if libc.BoolInt64(!(tmp != libc.UintptrFromInt32(0))) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__)), __ccgo_ts, int32(108), __ccgo_ts+11)
					}
				...
				*(*uint16_t)(unsafe.Pointer((*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata + uintptr(v4)*2)) = uint16(indent_length)
...
var __func__ = [41]int8{'t', 'r', 'e', 'e', '_', 's', 'i', 't', 't', 'e', 'r', '_', 'f', 'i', 'r', 'r', 't', 'l', '_', 'e', 'x', 't', 'e', 'r', 'n', 'a', 'l', '_', 's', 'c', 'a', 'n', 'n', 'e', 'r', '_', 's', 'c', 'a', 'n'}
...
func tree_sitter_firrtl_external_scanner_serialize(tls *libc.TLS, payload uintptr, buffer uintptr) (r uint32) {
	...
	for {
		...
		v2 = size
		size = size + 1
		*(*int8)(unsafe.Pointer(buffer + uintptr(v2))) = libc.Int8FromUint16(*(*uint16_t)(unsafe.Pointer((*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata + uintptr(iter)*2)))
		goto _1
	_1:
		;
		iter = iter + 1
...
func tree_sitter_firrtl_external_scanner_deserialize(tls *libc.TLS, payload uintptr, buffer uintptr, length uint32) {
	var scanner, tmp, tmp1, v4 uintptr
	var size size_t
	var v1 uint32
	var v3 uint32_t
	_, _, _, _, _, _, _ = scanner, size, tmp, tmp1, v1, v3, v4
	scanner = payload
	...
	if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fcap1 == (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 {
		...
		if libc.BoolInt64(!(tmp != libc.UintptrFromInt32(0))) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts, int32(149), __ccgo_ts+11)
		}
		(*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata = tmp
		if libc.Uint32FromInt32(libc.Int32FromInt32(16)) > (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1*uint32(2) {
			v1 = libc.Uint32FromInt32(libc.Int32FromInt32(16))
	...
	v4 = (*Scanner)(unsafe.Pointer(scanner)).Findents
	v3 = *(*uint32_t)(unsafe.Pointer(v4))
	*(*uint32_t)(unsafe.Pointer(v4)) = *(*uint32_t)(unsafe.Pointer(v4)) + 1
	*(*uint16_t)(unsafe.Pointer((*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata + uintptr(v3)*2)) = libc.Uint16FromInt32(libc.Int32FromInt32(0))
	if length > uint32(0) {
		size = uint64(0)
		for {
			...
			if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fcap1 == (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 {
				...
				if libc.BoolInt64(!(tmp1 != libc.UintptrFromInt32(0))) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts, int32(154), __ccgo_ts+11)
				}
			...
			v3 = *(*uint32_t)(unsafe.Pointer(v4))
			*(*uint32_t)(unsafe.Pointer(v4)) = *(*uint32_t)(unsafe.Pointer(v4)) + 1
			*(*uint16_t)(unsafe.Pointer((*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata + uintptr(v3)*2)) = uint16(libc.Uint8FromInt8(*(*int8)(unsafe.Pointer(buffer + uintptr(size)))))
			goto _5
		_5:
			;
			size = size + 1
		}
		if libc.BoolInt64(!(size == uint64(length))) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts, int32(156), __ccgo_ts+23)
		}
	}
}

var __func__1 = [48]int8{'t', 'r', 'e', 'e', '_', 's', 'i', 't', 't', 'e', 'r', '_', 'f', 'i', 'r', 'r', 't', 'l', '_', 'e', 'x', 't', 'e', 'r', 'n', 'a', 'l', '_', 's', 'c', 'a', 'n', 'n', 'e', 'r', '_', 'd', 'e', 's', 'e', 'r', 'i', 'a', 'l', 'i', 'z', 'e'}
