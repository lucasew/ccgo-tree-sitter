// Code generated for linux/386 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions -std=gnu11 -O0 -Dfunc=func_token -Dinterface=interface_token -Dselect=select_token -Dchan=chan_token -Dgo=go_token -Dmap=map_token -Dpackage=package_token -Dtype=type_token -Dvar=var_token -Dimport=import_token -Ddefer=defer_token -Dfallthrough=fallthrough_token -Drange=range_token -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-dockerfile/src -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-dockerfile -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/include -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/src combined.c -o grammar.go', DO NOT EDIT.
...
const MAX_HEREDOCS = 10
const PRODUCTION_ID_COUNT = 16
...
const STATE_COUNT = 325
const SYMBOL_COUNT = 164
const TOKEN_COUNT = 87
...
func tree_sitter_dockerfile_external_scanner_create(tls *libc.TLS) (r uintptr) {
	var state uintptr
	_ = state
	state = libc.Xmalloc(tls, uint32(48))
	libc.Xmemset(tls, state, 0, uint32(48))
	return state
}
...
func tree_sitter_dockerfile_external_scanner_destroy(tls *libc.TLS, payload uintptr) {
	...
	i = uint32(0)
	for {
		if !(i < uint32(MAX_HEREDOCS)) {
			break
		}
		if *(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i)*4)) != 0 {
			libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i)*4)))
		}
		goto _1
	_1:
		;
...
func tree_sitter_dockerfile_external_scanner_serialize(tls *libc.TLS, payload uintptr, buffer uintptr) (r uint32) {
	...
	*(*int8)(unsafe.Pointer(buffer + uintptr(v1))) = libc.Int8FromUint8((*scanner_state)(unsafe.Pointer(state)).Fstripping_heredoc)
	...
	for {
		...
		// well.
		len1 = libc.Xstrlen(tls, *(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i)*4))) + uint32(1)
		...
		if pos+len1+uint32(1) > uint32(TREE_SITTER_SERIALIZATION_BUFFER_SIZE) {
			break
		}
		libc.Xmemcpy(tls, buffer+uintptr(pos), *(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i)*4)), len1)
		pos = pos + len1
		goto _3
	_3:
		;
...
func tree_sitter_dockerfile_external_scanner_deserialize(tls *libc.TLS, payload uintptr, buffer uintptr, length uint32) {
	...
	for {
		...
		libc.Xfree(tls, *(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i)*4)))
		*(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i)*4)) = libc.UintptrFromInt32(0)
		goto _1
	_1:
		;
		i = i + 1
	...
	if length == uint32(0) {
		(*scanner_state)(unsafe.Pointer(state)).Fin_heredoc = libc.BoolUint8(false1 != 0)
		(*scanner_state)(unsafe.Pointer(state)).Fstripping_heredoc = libc.BoolUint8(false1 != 0)
		...
		i1 = uint32(0)
		for {
			if !(i1 < uint32(MAX_HEREDOCS)) {
				break
			}
			len1 = libc.Xstrlen(tls, buffer+uintptr(pos))
			...
			len1 = len1 + 1
			heredoc = libc.Xmalloc(tls, len1)
			libc.Xmemcpy(tls, heredoc, buffer+uintptr(pos), len1)
			*(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i1)*4)) = heredoc
...
func scan_marker(tls *libc.TLS, state uintptr, lexer uintptr) (r uint8) {
	...
	(*(*func(*libc.TLS, uintptr, uint8))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fadvance})))(tls, lexer, libc.BoolUint8(false1 != 0))
	stripping = libc.BoolUint8(false1 != 0)
	if (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('-') {
		stripping = libc.BoolUint8(true1 != 0)
		(*(*func(*libc.TLS, uintptr, uint8))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fadvance})))(tls, lexer, libc.BoolUint8(false1 != 0))
	}
	quote = 0
	...
	for {
		if v2 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead != int32('\000'); v2 {
			if quote != 0 {
				...
				v1 = libc.BoolInt32(!(libc.Xiswspace(tls, libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead)) != 0))
			}
		}
		if !(v2 && v1 != 0) {
			break
		...
		if del_idx >= libc.Uint32FromInt32(libc.Int32FromInt32(DEL_SPACE)-libc.Int32FromInt32(2)) {
			del_idx = uint32(0)
		}
	}
	if quote != 0 {
	...
	del_copy = libc.Xmalloc(tls, del_idx+uint32(1))
	libc.Xmemcpy(tls, del_copy, bp, del_idx+uint32(1))
	if (*scanner_state)(unsafe.Pointer(state)).Fheredoc_count == uint32(0) {
		...
		*(*uintptr)(unsafe.Pointer(state + 8)) = del_copy
		...
		if (*scanner_state)(unsafe.Pointer(state)).Fheredoc_count >= uint32(MAX_HEREDOCS) {
			libc.Xfree(tls, del_copy)
		} else {
			v6 = state + 4
			v3 = *(*uint32)(unsafe.Pointer(v6))
			*(*uint32)(unsafe.Pointer(v6)) = *(*uint32)(unsafe.Pointer(v6)) + 1
			*(*uintptr)(unsafe.Pointer(state + 8 + uintptr(v3)*4)) = del_copy
		}
	}
	(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(HEREDOC_MARKER)
	return libc.BoolUint8(true1 != 0)
...
func scan_content(tls *libc.TLS, state uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	(*scanner_state)(unsafe.Pointer(state)).Fin_heredoc = libc.BoolUint8(true1 != 0)
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(HEREDOC_END))) != 0 {
		...
		if int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(state + 8)) + uintptr(delim_idx)))) == int32('\000') {
			...
			for {
				...
				*(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i-uint32(1))*4)) = *(*uintptr)(unsafe.Pointer(state + 8 + uintptr(i)*4))
				goto _1
			_1:
				;
				i = i + 1
			}
			*(*uintptr)(unsafe.Pointer(state + 8 + uintptr((*scanner_state)(unsafe.Pointer(state)).Fheredoc_count-uint32(1))*4)) = libc.UintptrFromInt32(0)
...
start:
	...
	case 0:
		...
		i = uint32(0)
		for {
			if !(i < libc.Uint32FromInt64(64)/libc.Uint32FromInt64(2)) {
				break
			}
	...
	case int32(13):
		i2 = uint32(0)
		for {
			if !(i2 < libc.Uint32FromInt64(36)/libc.Uint32FromInt64(2)) {
				break
			}
	...
	case int32(164):
		...
		i4 = uint32(0)
		for {
			if !(i4 < libc.Uint32FromInt64(52)/libc.Uint32FromInt64(2)) {
				break
			}
	...
	case int32(165):
		...
		i5 = uint32(0)
		for {
			if !(i5 < libc.Uint32FromInt64(148)/libc.Uint32FromInt64(2)) {
				break
			}
	...
	case int32(166):
		...
		i6 = uint32(0)
		for {
			if !(i6 < libc.Uint32FromInt64(140)/libc.Uint32FromInt64(2)) {
				break
			}
...
func init() {
	...
	*(*uintptr)(unsafe.Add(p, 112)) = __ccgo_fp(tree_sitter_dockerfile_external_scanner_create)
	*(*uintptr)(unsafe.Add(p, 116)) = __ccgo_fp(tree_sitter_dockerfile_external_scanner_destroy)
	*(*uintptr)(unsafe.Add(p, 120)) = __ccgo_fp(tree_sitter_dockerfile_external_scanner_scan)
	*(*uintptr)(unsafe.Add(p, 124)) = __ccgo_fp(tree_sitter_dockerfile_external_scanner_serialize)
	*(*uintptr)(unsafe.Add(p, 128)) = __ccgo_fp(tree_sitter_dockerfile_external_scanner_deserialize)
}
