...
func scan_raw_text(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts, int32(165), __ccgo_ts+11)
	}
...
func scan_implicit_end_tag(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	if (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize == uint32(0) {
		...
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__6)), __ccgo_ts, int32(192), __ccgo_ts+11)
		}
		v1 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	if is_closing_tag != 0 {
		...
		if v4 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v4 {
			if libc.BoolInt64(!((*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__6)), __ccgo_ts, int32(216), __ccgo_ts+11)
			}
			v5 = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
	...
	*(*Tag)(unsafe.Pointer(bp + 32)) = v6
	if v12 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v12 {
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__5)), __ccgo_ts, int32(281), __ccgo_ts+11)
		}
		v5 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func scan(tls *libc.TLS, scanner uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	var v3 __darwin_ct_rune_t
	var v4 uint64
	_, _, _, _, _, _, _, _ = advanced_once, is_error_recovery, v1, v3, v4, v5, v7, v8
...
func tree_sitter_vue_external_scanner_destroy(tls *libc.TLS, payload uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__2)), __ccgo_ts, int32(465), __ccgo_ts+92)
		}
		v2 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
