...
func scan_pi_target(tls *libc.TLS, lexer1 uintptr, valid_symbols uintptr) (r uint8) {
	...
	var v7 uint64
	_, _, _, _, _, _, _, _, _, _, _ = advanced_once, found_x_first, v1, v10, v11, v13, v2, v4, v6, v7, v8
