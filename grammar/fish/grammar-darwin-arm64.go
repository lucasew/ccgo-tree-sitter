...
func tree_sitter_fish_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	var v4 uint64
	var v19 bool
	_, _, _, _, _, _, _ = v1, v19, v3, v4, v5, v7, v8
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(BEGIN_BRACE))) != 0 {
		...
		if (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('{') {
			...
			if v19 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(';'); !v19 {
				v3 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead
				v4 = uint64(0x00004000)
				v8 = libc.BoolInt32(v3 & ^libc.Int32FromInt32(0x7F) == 0)
				goto _18
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(CONCAT))) != 0 {
		if v19 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('>') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('<') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(')') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(';') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('&') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('|'); !v19 {
			v3 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead
			v4 = uint64(0x00004000)
			v8 = libc.BoolInt32(v3 & ^libc.Int32FromInt32(0x7F) == 0)
			goto _28
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(BRACKET_CONCAT))) != 0 {
		if v19 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(')') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('(') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('}') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(','); !v19 {
			v3 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead
			v4 = uint64(0x00004000)
			v8 = libc.BoolInt32(v3 & ^libc.Int32FromInt32(0x7F) == 0)
			goto _38
