...
func scan(tls *libc.TLS, lexer uintptr, scanner uintptr, chr int8, symbol int32) (r uint8) {
	...
	for {
		...
		if symbol == int32(EQUALS_BEGIN) && !((*Scanner)(unsafe.Pointer(scanner)).Finitialized != 0) {
			(*Scanner)(unsafe.Pointer(scanner)).Fsuffix = uint16((*TSLexer)(unsafe.Pointer(lexer)).Flookahead)
		}
		if int32((*Scanner)(unsafe.Pointer(scanner)).Fsuffix) != (*TSLexer)(unsafe.Pointer(lexer)).Flookahead {
			return libc.BoolUint8(false1 != 0)
		}
		advance(tls, lexer)
		goto _2
	...
	(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(symbol)
...
func tree_sitter_test_external_scanner_create(tls *libc.TLS) (r uintptr) {
	var scanner uintptr
	_ = scanner
	scanner = libc.Xmalloc(tls, uint64(8))
	(*Scanner)(unsafe.Pointer(scanner)).Flength = uint32(0)
	(*Scanner)(unsafe.Pointer(scanner)).Fsuffix = uint16('\000')
...
func tree_sitter_test_external_scanner_serialize(tls *libc.TLS, payload uintptr, buffer uintptr) (r uint32) {
	...
	libc.Xmemset(tls, buffer+uintptr(1), int32((*Scanner)(unsafe.Pointer(scanner)).Fsuffix), uint64((*Scanner)(unsafe.Pointer(scanner)).Flength))
...
func tree_sitter_test_external_scanner_deserialize(tls *libc.TLS, payload uintptr, buffer uintptr, length uint32_t) {
	...
	(*Scanner)(unsafe.Pointer(scanner)).Fsuffix = uint16(*(*int8)(unsafe.Pointer(buffer + 1)))
	(*Scanner)(unsafe.Pointer(scanner)).Finitialized = uint8(libc.BoolInt8(*(*int8)(unsafe.Pointer(buffer)) != 0))
}
