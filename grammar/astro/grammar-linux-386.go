// Code generated for linux/386 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions -std=gnu11 -O0 -Dfunc=func_token -Dinterface=interface_token -Dselect=select_token -Dchan=chan_token -Dgo=go_token -Dmap=map_token -Dpackage=package_token -Dtype=type_token -Dvar=var_token -Dimport=import_token -Ddefer=defer_token -Dfallthrough=fallthrough_token -Drange=range_token -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-astro/src -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-astro -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/include -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/src combined.c -o grammar.go', DO NOT EDIT.
...
_17:
	;
	if !(libc.Uint32FromInt32(i) < libc.Uint32FromInt64(104)/libc.Uint32FromInt64(4)) {
		goto _15
	}
		...
		if in_comment == 0 {
			...
			if end_type == int32(EndFrontmatter) {
				...
				if (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(*(*int8)(unsafe.Pointer(END + uintptr(delimiter_index)))) {
					...
					if delimiter_index == libc.Xstrlen(tls, END) {
						break
					}
				} else {
...
func scan_start_tag_name(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	*(*String)(unsafe.Pointer(bp + 12)) = scan_tag_name(tls, lexer)
	if (*(*String)(unsafe.Pointer(bp + 12))).Fsize == uint32(0) {
		...
		if (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('>') {
			...
			if new_size > (*Array)(unsafe.Pointer(v1)).Fcapacity {
				...
				v2 = v1
				v4 = uint32(libc.Uint32FromInt64(16))
				v5 = new_capacity1
			...
			*(*Tag)(unsafe.Pointer((*struct {
				...
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(scanner)).Fcontents + uintptr(v6)*16)) = tag2
	...
	v8 = *(*String)(unsafe.Pointer(bp + 12))
...
_13:
	...
	if new_size > (*Array)(unsafe.Pointer(v2)).Fcapacity {
		...
		if v5 > (*Array)(unsafe.Pointer(v3)).Fcapacity {
			if (*Array)(unsafe.Pointer(v3)).Fcontents != 0 {
				(*Array)(unsafe.Pointer(v3)).Fcontents = libc.Xrealloc(tls, (*Array)(unsafe.Pointer(v3)).Fcontents, v5*v4)
			} else {
				(*Array)(unsafe.Pointer(v3)).Fcontents = libc.Xmalloc(tls, v5*v4)
			}
	...
	*(*Tag)(unsafe.Pointer((*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(scanner)).Fcontents + uintptr(v6)*16)) = tag3
...
func scan_end_tag_name(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	*(*String)(unsafe.Pointer(bp + 12)) = scan_tag_name(tls, lexer)
	if (*(*String)(unsafe.Pointer(bp + 12))).Fsize == uint32(0) {
		...
		if (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('>') {
			...
			if v3 && (*Tag)(unsafe.Pointer((*struct {
				...
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(scanner)).Fsize-uint32(1))*16)).Ftype_token == int32(FRAGMENT) {
				pop_tag(tls, scanner)
				(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(FRAGMENT_TAG_DELIM)
				return libc.BoolUint8(true1 != 0)
			} else {
	...
	v4 = *(*String)(unsafe.Pointer(bp + 12))
	...
	*(*Tag)(unsafe.Pointer(bp + 24)) = v8
	if v3 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v3 {
		...
		if (*Tag)(unsafe.Pointer(v7)).Ftype_token == int32(CUSTOM) {
			...
			if libc.Xmemcmp(tls, (*Tag)(unsafe.Pointer(v7)).Fcustom_tag_name.Fcontents, (*Tag)(unsafe.Pointer(v11)).Fcustom_tag_name.Fcontents, (*Tag)(unsafe.Pointer(v7)).Fcustom_tag_name.Fsize) != libc.Int32FromInt32(0) {
				v13 = libc.BoolUint8(false1 != 0)
				goto _14
			}
		}
...
func scan(tls *libc.TLS, scanner uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	case int32('{'):
		if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(HTML_INTERPOLATION_START))) != 0 {
			...
			if new_size > (*Array)(unsafe.Pointer(v1)).Fcapacity {
				...
				v2 = v1
				v3 = uint32(libc.Uint32FromInt64(16))
				v4 = new_capacity1
				if v4 > (*Array)(unsafe.Pointer(v2)).Fcapacity {
					if (*Array)(unsafe.Pointer(v2)).Fcontents != 0 {
						(*Array)(unsafe.Pointer(v2)).Fcontents = libc.Xrealloc(tls, (*Array)(unsafe.Pointer(v2)).Fcontents, v4*v3)
			...
			*(*Tag)(unsafe.Pointer((*struct {
				...
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(scanner)).Fcontents + uintptr(v5)*16)) = tag
	...
	case int32('}'):
		...
		if v8 && (*Tag)(unsafe.Pointer((*struct {
			...
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(scanner)).Fsize-uint32(1))*16)).Ftype_token == int32(INTERPOLATION) {
			(*(*func(*libc.TLS, uintptr, uint8))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fadvance})))(tls, lexer, libc.BoolUint8(false1 != 0))
			v1 = scanner + 4
			*(*uint32_t)(unsafe.Pointer(v1)) = *(*uint32_t)(unsafe.Pointer(v1)) - 1
			...
			_ = *(*Tag)(unsafe.Pointer((*struct {
				...
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(scanner)).Fcontents + uintptr(v4)*16))
...
func init() {
	...
	*(*uintptr)(unsafe.Add(p, 112)) = __ccgo_fp(tree_sitter_astro_external_scanner_create)
	*(*uintptr)(unsafe.Add(p, 116)) = __ccgo_fp(tree_sitter_astro_external_scanner_destroy)
	*(*uintptr)(unsafe.Add(p, 120)) = __ccgo_fp(tree_sitter_astro_external_scanner_scan)
	*(*uintptr)(unsafe.Add(p, 124)) = __ccgo_fp(tree_sitter_astro_external_scanner_serialize)
	*(*uintptr)(unsafe.Add(p, 128)) = __ccgo_fp(tree_sitter_astro_external_scanner_deserialize)
}
