		...
		if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 > uint32(0) {
			...
			if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(INDENT))) != 0 && indent_length > uint32(current_indent_length) {
				if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fcap1 == (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 {
					if uint32(libc.Int32FromInt32(16)) > (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1*uint32(2) {
						v2 = uint32(libc.Int32FromInt32(16))
					} else {
					...
					if v3 = !!(tmp != libc.UintptrFromInt32(0)); !v3 {
						libc.X_assert(tls, __ccgo_ts, __ccgo_ts+12, uint32(108))
					}
...
func tree_sitter_firrtl_external_scanner_serialize(tls *libc.TLS, payload uintptr, buffer uintptr) (r uint32) {
	...
	iter = int32(1)
	for {
		if !(uint32(iter) < (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 && size < uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE)) {
			break
		}
		v2 = size
		size = size + 1
		*(*int8)(unsafe.Pointer(buffer + uintptr(v2))) = int8(*(*uint16_t)(unsafe.Pointer((*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata + uintptr(iter)*2)))
		goto _1
	_1:
		;
		iter = iter + 1
...
func tree_sitter_firrtl_external_scanner_deserialize(tls *libc.TLS, payload uintptr, buffer uintptr, length uint32) {
	...
	if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fcap1 == (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 {
		if uint32(libc.Int32FromInt32(16)) > (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1*uint32(2) {
			v1 = uint32(libc.Int32FromInt32(16))
		} else {
		...
		if v2 = !!(tmp != libc.UintptrFromInt32(0)); !v2 {
			libc.X_assert(tls, __ccgo_ts, __ccgo_ts+12, uint32(149))
		}
	...
	*(*uint16_t)(unsafe.Pointer((*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata + uintptr(v4)*2)) = uint16(libc.Int32FromInt32(0))
	if length > uint32(0) {
		size = uint64(0)
		for {
			...
			if (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fcap1 == (*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Flen1 {
				...
				if v2 = !!(tmp1 != libc.UintptrFromInt32(0)); !v2 {
					libc.X_assert(tls, __ccgo_ts, __ccgo_ts+12, uint32(154))
				}
				_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
			...
			v4 = *(*uint32_t)(unsafe.Pointer(v5))
			*(*uint32_t)(unsafe.Pointer(v5)) = *(*uint32_t)(unsafe.Pointer(v5)) + 1
			*(*uint16_t)(unsafe.Pointer((*indent_vec)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Findents)).Fdata + uintptr(v4)*2)) = uint16(uint8(*(*int8)(unsafe.Pointer(buffer + uintptr(size)))))
			goto _6
		_6:
			;
			size = size + 1
		...
		if v2 = !!(size == uint64(length)); !v2 {
			libc.X_assert(tls, __ccgo_ts+23, __ccgo_ts+12, uint32(156))
		}
		_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	}
}
...
start:
	...
	case 0:
		...
		for {
			...
			if int32(map_token4[i]) == lookahead {
...
var ts_parse_actions = [1099]TSParseActionEntry{
	...
	1066: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Fstate: uint16(libc.Int32FromInt32(406)),
	}})))),
