...
var ts_parse_actions struct {
	...
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 0}, [6]byte{}}, TSParseActionEntry{TSParseAction{anon.0{1, 3, 15, 0, 0}}}, struct {
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 0}, [6]byte{}}, struct {
	F0 struct {
	...
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 1}, [6]byte{}}, TSParseActionEntry{TSParseAction{anon.0{1, 4, 14, 0, 0}}}, struct {
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 0}, [6]byte{}}, struct {
	F0 struct {
	...
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 1}, [6]byte{}}, TSParseActionEntry{TSParseAction{anon.0{1, 3, 13, 0, 0}}}, struct {
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 1}, [6]byte{}}, TSParseActionEntry{TSParseAction{anon.0{1, 4, 15, 0, 0}}}, struct {
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 1}, [6]byte{}}, TSParseActionEntry{TSParseAction{anon.0{1, 5, 14, 0, 0}}}, struct {
	F0 anon.1
	F1 [6]byte
}{anon.1{1, 1}, [6]byte{}}, struct {
	F0 struct {
...
if_end167:
	v65 = *result
	tobool168 = byte(v65 & 1)
	*retval = tobool168
	goto _return

sw_bb169:
	v66 = *eof
	tobool170 = byte(v66 & 1)
	if tobool170 {
		goto if_then171
	} else {
		goto if_end172
...
if_end204:
	v76 = *result
	tobool205 = byte(v76 & 1)
	*retval = tobool205
	goto _return

sw_bb206:
	v77 = *eof
	tobool207 = byte(v77 & 1)
	if tobool207 {
		goto if_then208
	} else {
		goto if_end209
