...
start:
	...
	case 0:
		...
		i = uint32(0)
		for {
			if !(uint64(i) < libc.Uint64FromInt64(116)/libc.Uint64FromInt64(2)) {
				break
			}
	...
	case int32(18):
		...
		i3 = uint32(0)
		for {
			if !(uint64(i3) < libc.Uint64FromInt64(112)/libc.Uint64FromInt64(2)) {
				break
			}
...
func init() {
	...
	*(*uintptr)(unsafe.Add(p, 184)) = __ccgo_fp(tree_sitter_yuck_external_scanner_create)
	*(*uintptr)(unsafe.Add(p, 192)) = __ccgo_fp(tree_sitter_yuck_external_scanner_destroy)
	*(*uintptr)(unsafe.Add(p, 200)) = __ccgo_fp(tree_sitter_yuck_external_scanner_scan)
	*(*uintptr)(unsafe.Add(p, 208)) = __ccgo_fp(tree_sitter_yuck_external_scanner_serialize)
	*(*uintptr)(unsafe.Add(p, 216)) = __ccgo_fp(tree_sitter_yuck_external_scanner_deserialize)
}
