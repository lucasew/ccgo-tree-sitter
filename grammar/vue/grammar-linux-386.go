// Code generated for linux/386 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions -std=gnu11 -O0 -Dfunc=func_token -Dinterface=interface_token -Dselect=select_token -Dchan=chan_token -Dgo=go_token -Dmap=map_token -Dpackage=package_token -Dtype=type_token -Dvar=var_token -Dimport=import_token -Ddefer=defer_token -Dfallthrough=fallthrough_token -Drange=range_token -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-vue/src -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-vue -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/include -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/src combined.c -o grammar.go', DO NOT EDIT.
...
const STATE_COUNT = 170
const SUPERTYPE_COUNT = 0
const SYMBOL_COUNT = 67
const TMP_MAX = 10000
...
// #define advance(lexer)                                                                                                 //     do {                                                                                                               //         printf("advance %c, line: %d\n", lexer->lookahead, __LINE__);                                                  //         (lexer->advance)(lexer, false);                                                                                //     } while (0)
//
// #define skip(lexer) //     do { //         printf("skip %c, line: %d\n", lexer->lookahead, __LINE__); //         (lexer->advance)(lexer, true); //     } while (0)
...
func deserialize(tls *libc.TLS, scanner uintptr, buffer uintptr, length uint32) {
	...
	for {
		...
		v2 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fcontents + uintptr(i)*16
	...
	if length > uint32(0) {
		...
		*(*uint16_t)(unsafe.Pointer(bp + 2)) = uint16(0)
		...
		size = uint32(size + libc.Uint32FromInt64(2))
		v2 = scanner
		v5 = uint32(libc.Uint32FromInt64(16))
		v6 = uint32(*(*uint16_t)(unsafe.Pointer(bp)))
		if v6 > (*Array)(unsafe.Pointer(v2)).Fcapacity {
			if (*Array)(unsafe.Pointer(v2)).Fcontents != 0 {
				(*Array)(unsafe.Pointer(v2)).Fcontents = libc.Xrealloc(tls, (*Array)(unsafe.Pointer(v2)).Fcontents, v6*v5)
			} else {
				(*Array)(unsafe.Pointer(v2)).Fcontents = libc.Xmalloc(tls, v6*v5)
			}
		...
		if libc.Int32FromUint16(*(*uint16_t)(unsafe.Pointer(bp))) > 0 {
			...
			for {
				...
				goto _9
			_9:
				*(*Tag)(unsafe.Pointer(bp + 4)) = v8
				v10 = size
				size = size + 1
				(*(*Tag)(unsafe.Pointer(bp + 4))).Ftype_token = int32(*(*int8)(unsafe.Pointer(buffer + uintptr(v10))))
				...
				*(*Tag)(unsafe.Pointer((*struct {
					...
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(scanner)).Fcontents + uintptr(v14)*16)) = *(*Tag)(unsafe.Pointer(bp + 4))
				goto _7
			_7:
				;
				iter = iter + 1
			...
			_29:
				*(*Tag)(unsafe.Pointer((*struct {
					...
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(scanner)).Fcontents + uintptr(v14)*16)) = v8
				goto _21
			_21:
				;
				iter = iter + 1
	...
	*(*String)(unsafe.Pointer(bp)) = String{}
	for libc.Xiswalnum(tls, libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead)) != 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('-') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(':') {
		...
		if new_size > (*Array)(unsafe.Pointer(v1)).Fcapacity {
			...
			v2 = v1
			v3 = uint32(libc.Uint32FromInt64(1))
			v4 = new_capacity1
			if v4 > (*Array)(unsafe.Pointer(v2)).Fcapacity {
				if (*Array)(unsafe.Pointer(v2)).Fcontents != 0 {
					(*Array)(unsafe.Pointer(v2)).Fcontents = libc.Xrealloc(tls, (*Array)(unsafe.Pointer(v2)).Fcontents, v4*v3)
				} else {
					(*Array)(unsafe.Pointer(v2)).Fcontents = libc.Xmalloc(tls, v4*v3)
				}
		...
		*(*int8)(unsafe.Pointer((*String)(unsafe.Pointer(bp)).Fcontents + uintptr(v5))) = libc.Int8FromUint32(libc.Xtowupper(tls, libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead)))
		advance(tls, lexer)
	}
...
func scan_raw_text(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	if v2 = (*struct {
		...
		libc.X__assert_fail(tls, __ccgo_ts, __ccgo_ts+64, int32(165), uintptr(unsafe.Pointer(&__func__)))
	}
...
func scan_implicit_end_tag(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	var v2, v5 bool
	var v7 String
	var _ /* next_tag at bp+24 */ Tag
	var _ /* tag_name at bp+12 */ String
	...
	if (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize == uint32(0) {
		...
		if v2 = (*struct {
			...
			libc.X__assert_fail(tls, __ccgo_ts, __ccgo_ts+64, int32(192), uintptr(unsafe.Pointer(&__func__6)))
		}
		_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
		v1 = (*struct {
			Fcontents uintptr
	...
	*(*String)(unsafe.Pointer(bp + 12)) = scan_tag_name(tls, lexer)
	if (*(*String)(unsafe.Pointer(bp + 12))).Fsize == uint32(0) && !((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0) {
		v1 = bp + 12
	...
	v7 = *(*String)(unsafe.Pointer(bp + 12))
	...
	if is_closing_tag != 0 {
		...
		if v5 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v5 {
			if v2 = (*struct {
				...
				libc.X__assert_fail(tls, __ccgo_ts, __ccgo_ts+64, int32(216), uintptr(unsafe.Pointer(&__func__6)))
			}
			_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
			v6 = (*struct {
				Fcontents uintptr
			...
			if (*Tag)(unsafe.Pointer(v6)).Ftype_token == int32(CUSTOM) {
				...
				if libc.Xmemcmp(tls, (*Tag)(unsafe.Pointer(v6)).Fcustom_tag_name.Fcontents, (*Tag)(unsafe.Pointer(v10)).Fcustom_tag_name.Fcontents, (*Tag)(unsafe.Pointer(v6)).Fcustom_tag_name.Fsize) != libc.Int32FromInt32(0) {
					v3 = libc.BoolUint8(false1 != 0)
					goto _17
				}
			}
		...
		for {
			...
			if (*(*Tag)(unsafe.Pointer((*Scanner)(unsafe.Pointer(scanner)).Ftags.Fcontents + uintptr(i-uint32(1))*16))).Ftype_token == (*(*Tag)(unsafe.Pointer(bp + 24))).Ftype_token {
				pop_tag(tls, scanner)
				(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(IMPLICIT_END_TAG)
				v1 = bp + 24
		...
		if parent != 0 && (!(tag_can_contain(tls, parent, bp+24) != 0) || ((*Tag)(unsafe.Pointer(parent)).Ftype_token == int32(HTML) || (*Tag)(unsafe.Pointer(parent)).Ftype_token == int32(HEAD) || (*Tag)(unsafe.Pointer(parent)).Ftype_token == int32(BODY)) && (*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0) {
			pop_tag(tls, scanner)
			(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(IMPLICIT_END_TAG)
			v1 = bp + 24
			if (*Tag)(unsafe.Pointer(v1)).Ftype_token == int32(CUSTOM) {
...
func scan_start_tag_name(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	*(*String)(unsafe.Pointer(bp + 12)) = scan_tag_name(tls, lexer)
	if (*(*String)(unsafe.Pointer(bp + 12))).Fsize == uint32(0) {
		v1 = bp + 12
		if (*Array)(unsafe.Pointer(v1)).Fcontents != 0 {
			libc.Xfree(tls, (*Array)(unsafe.Pointer(v1)).Fcontents)
			(*Array)(unsafe.Pointer(v1)).Fcontents = libc.UintptrFromInt32(0)
	...
	v2 = *(*String)(unsafe.Pointer(bp + 12))
...
_7:
	...
	if new_size > (*Array)(unsafe.Pointer(v5)).Fcapacity {
		...
		v8 = v5
		v10 = uint32(libc.Uint32FromInt64(16))
		v11 = new_capacity1
		if v11 > (*Array)(unsafe.Pointer(v8)).Fcapacity {
			if (*Array)(unsafe.Pointer(v8)).Fcontents != 0 {
				(*Array)(unsafe.Pointer(v8)).Fcontents = libc.Xrealloc(tls, (*Array)(unsafe.Pointer(v8)).Fcontents, v11*v10)
			} else {
				(*Array)(unsafe.Pointer(v8)).Fcontents = libc.Xmalloc(tls, v11*v10)
			}
	...
	*(*Tag)(unsafe.Pointer((*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(scanner)).Fcontents + uintptr(v12)*16)) = tag2
	...
	*(*Tag)(unsafe.Pointer(bp + 24)) = v6
	if v13 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v13 {
		if v8 = (*struct {
			...
			libc.X__assert_fail(tls, __ccgo_ts, __ccgo_ts+64, int32(281), uintptr(unsafe.Pointer(&__func__5)))
		}
		...
		if (*Tag)(unsafe.Pointer(v5)).Ftype_token == int32(CUSTOM) {
			...
			if libc.Xmemcmp(tls, (*Tag)(unsafe.Pointer(v5)).Fcustom_tag_name.Fcontents, (*Tag)(unsafe.Pointer(v9)).Fcustom_tag_name.Fcontents, (*Tag)(unsafe.Pointer(v5)).Fcustom_tag_name.Fsize) != libc.Int32FromInt32(0) {
				v11 = libc.BoolUint8(false1 != 0)
				goto _12
			}
		}
	...
	if !(is_error_recovery != 0) && (*TSLexer)(unsafe.Pointer(lexer)).Flookahead != int32('<') && (*(*uint8)(unsafe.Pointer(valid_symbols + uintptr(TEXT_FRAGMENT))) != 0 || *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(INTERPOLATION_TEXT))) != 0) {
		...
		for !((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0) {
			...
			case int32('<'):
				(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
				advance(tls, lexer)
				if libc.Xiswalpha(tls, libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead)) != 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('!') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('?') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('/') {
					goto loop_exit
				}
			...
			default:
				advanced_once = libc.Uint8FromInt32(libc.BoolInt32(int32(advanced_once)|libc.BoolInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead != libc.Int32FromUint8('\n')) != 0))
				advance(tls, lexer)
				break
			}
		}
...
func tree_sitter_vue_external_scanner_destroy(tls *libc.TLS, payload uintptr) {
	var i uint32
	var scanner, v3, v4 uintptr
	var v2 bool
	_, _, _, _, _ = i, scanner, v2, v3, v4
	scanner = payload
	i = uint32(0)
	for {
		if !(i < (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize) {
		...
		if v2 = i < (*struct {
			...
			libc.X__assert_fail(tls, __ccgo_ts+92, __ccgo_ts+64, int32(465), uintptr(unsafe.Pointer(&__func__2)))
		}
		_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
		v3 = (*struct {
			Fcontents uintptr
...
var __func__2 = [41]int8{'t', 'r', 'e', 'e', '_', 's', 'i', 't', 't', 'e', 'r', '_', 'v', 'u', 'e', '_', 'e', 'x', 't', 'e', 'r', 'n', 'a', 'l', '_', 's', 'c', 'a', 'n', 'n', 'e', 'r', '_', 'd', 'e', 's', 't', 'r', 'o', 'y'}
...
start:
	...
	case int32(5):
		i3 = uint32(0)
		for {
			if !(i3 < libc.Uint32FromInt64(32)/libc.Uint32FromInt64(2)) {
				break
			}
	...
	case int32(26):
		...
		i4 = uint32(0)
		for {
			if !(i4 < libc.Uint32FromInt64(64)/libc.Uint32FromInt64(2)) {
				break
			}
...
func init() {
	...
	*(*uintptr)(unsafe.Add(p, 112)) = __ccgo_fp(tree_sitter_vue_external_scanner_create)
	*(*uintptr)(unsafe.Add(p, 116)) = __ccgo_fp(tree_sitter_vue_external_scanner_destroy)
	*(*uintptr)(unsafe.Add(p, 120)) = __ccgo_fp(tree_sitter_vue_external_scanner_scan)
	*(*uintptr)(unsafe.Add(p, 124)) = __ccgo_fp(tree_sitter_vue_external_scanner_serialize)
	*(*uintptr)(unsafe.Add(p, 128)) = __ccgo_fp(tree_sitter_vue_external_scanner_deserialize)
}
