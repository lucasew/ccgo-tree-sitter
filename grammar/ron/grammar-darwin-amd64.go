...
func is_num_char(tls *libc.TLS, c int32_t) (r uint8) {
	var v1, v6 int32
	var v3, v4 __darwin_ct_rune_t
	var v7 bool
	_, _, _, _, _ = v1, v3, v4, v6, v7
	if v7 = c == int32('_'); !v7 {
		v3 = c
		if v3 < 0 || v3 >= libc.Int32FromInt32(1)<<libc.Int32FromInt32(8) {
			v6 = 0
		} else {
			v6 = libc.BoolInt32(!!(uint64(*(*__uint32_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&libc.X_DefaultRuneLocale)) + 60 + uintptr(v3)*4)))&uint64(0x00000400) != 0))
		}
		v4 = v6
		goto _5
	_5:
...
func tree_sitter_ron_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	var v14, v4 __darwin_ct_rune_t
	var v18 bool
	var v5 uint64
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = after_star, has_content, has_exponent, has_fraction, hash_count, nesting_depth, opening_hash_count, v14, v18, v2, v4, v5, v6, v8, v9
	...
	if v18 = *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(FLOAT))) != 0; v18 {
		v4 = (*TSLexer)(unsafe.Pointer(lexer)).Flookahead
		if v4 < 0 || v4 >= libc.Int32FromInt32(1)<<libc.Int32FromInt32(8) {
			v6 = 0
		} else {
			v6 = libc.BoolInt32(!!(uint64(*(*__uint32_t)(unsafe.Pointer(uintptr(unsafe.Pointer(&libc.X_DefaultRuneLocale)) + 60 + uintptr(v4)*4)))&uint64(0x00000400) != 0))
		}
		v14 = v6
		goto _16
	_16:
