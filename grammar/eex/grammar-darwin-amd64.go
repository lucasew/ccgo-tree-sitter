...
const anon_sym_LT_PERCENT = 1
const anon_sym_LT_PERCENT_EQ = 2
const anon_sym_LT_PERCENT_PERCENT = 3
const anon_sym_LT_PERCENT_PERCENT_EQ = 4
const anon_sym_PERCENT_GT = 5
const aux_sym_partial_expression_token1 = 6
const anon_sym_do = 7
const anon_sym_DASH_GT = 8
const anon_sym_POUND = 9
const anon_sym_LT_PERCENT_POUND = 10
const anon_sym_LT_PERCENT_BANG_DASH_DASH = 11
const aux_sym__bang_comment_token1 = 12
const anon_sym_DASH_DASH_PERCENT_GT = 13
const sym_text = 14
const sym__code = 15
const sym_fragment = 16
const sym__node = 17
const sym_directive = 18
const sym_partial_expression = 19
const sym_expression = 20
const sym_comment = 21
const sym__hash_comment = 22
const sym__bang_comment = 23
const aux_sym_fragment_repeat1 = 24
const aux_sym_partial_expression_repeat1 = 25
const aux_sym__bang_comment_repeat1 = 26

var ts_symbol_names = [27]uintptr{
	0:  __ccgo_ts,
	1:  __ccgo_ts + 4,
	2:  __ccgo_ts + 7,
	3:  __ccgo_ts + 11,
...
var ts_symbol_map = [27]TSSymbol{
	1:  uint16(anon_sym_LT_PERCENT),
	2:  uint16(anon_sym_LT_PERCENT_EQ),
	3:  uint16(anon_sym_LT_PERCENT_PERCENT),
	4:  uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	5:  uint16(anon_sym_PERCENT_GT),
	6:  uint16(aux_sym_partial_expression_token1),
	7:  uint16(anon_sym_do),
	8:  uint16(anon_sym_DASH_GT),
	9:  uint16(anon_sym_POUND),
	10: uint16(anon_sym_LT_PERCENT_POUND),
	11: uint16(anon_sym_LT_PERCENT_BANG_DASH_DASH),
	12: uint16(aux_sym__bang_comment_token1),
	13: uint16(anon_sym_DASH_DASH_PERCENT_GT),
	14: uint16(sym_text),
	15: uint16(sym__code),
	16: uint16(sym_fragment),
	17: uint16(sym__node),
	18: uint16(sym_directive),
	19: uint16(sym_partial_expression),
	20: uint16(sym_expression),
	21: uint16(sym_comment),
	22: uint16(sym__hash_comment),
	23: uint16(sym__bang_comment),
	24: uint16(aux_sym_fragment_repeat1),
	25: uint16(aux_sym_partial_expression_repeat1),
	26: uint16(aux_sym__bang_comment_repeat1),
}

var ts_symbol_metadata = [27]TSSymbolMetadata{
	0: {
...
start:
	...
	case int32(22):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(aux_sym_partial_expression_token1)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
	...
	case int32(23):
		...
		if lookahead != 0 && lookahead != int32('\t') && lookahead != int32('\n') && lookahead != int32('\r') && lookahead != int32(' ') && lookahead != int32('%') {
			state = uint16(46)
			goto next_state
		}
		return result
	...
	case int32(31):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(aux_sym__bang_comment_token1)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if lookahead == int32('-') {
			state = uint16(32)
			goto next_state
...
var ts_parse_table = [4][27]uint16_t{
	0: {
		0:  uint16(1),
		1:  uint16(1),
		2:  uint16(1),
...
var ts_small_parse_table = [280]uint16_t{
	0:   uint16(6),
	1:   uint16(31),
	2:   uint16(1),
	3:   uint16(anon_sym_PERCENT_GT),
	4:   uint16(33),
	5:   uint16(1),
	6:   uint16(aux_sym_partial_expression_token1),
	7:   uint16(37),
	...
	10:  uint16(13),
	11:  uint16(1),
	12:  uint16(aux_sym_partial_expression_repeat1),
	13:  uint16(35),
	14:  uint16(2),
	15:  uint16(anon_sym_do),
	16:  uint16(anon_sym_DASH_GT),
	17:  uint16(28),
	18:  uint16(2),
	19:  uint16(sym_partial_expression),
	20:  uint16(sym_expression),
	...
	25:  uint16(41),
	26:  uint16(7),
	27:  uint16(anon_sym_LT_PERCENT),
	28:  uint16(anon_sym_LT_PERCENT_EQ),
	29:  uint16(anon_sym_LT_PERCENT_PERCENT),
	30:  uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	31:  uint16(anon_sym_LT_PERCENT_POUND),
	...
	38:  uint16(45),
	39:  uint16(7),
	40:  uint16(anon_sym_LT_PERCENT),
	41:  uint16(anon_sym_LT_PERCENT_EQ),
	42:  uint16(anon_sym_LT_PERCENT_PERCENT),
	43:  uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	44:  uint16(anon_sym_LT_PERCENT_POUND),
	45:  uint16(anon_sym_LT_PERCENT_BANG_DASH_DASH),
	46:  uint16(sym_text),
	47:  uint16(2),
	48:  uint16(47),
	49:  uint16(1),
	51:  uint16(49),
	52:  uint16(7),
	53:  uint16(anon_sym_LT_PERCENT),
	54:  uint16(anon_sym_LT_PERCENT_EQ),
	55:  uint16(anon_sym_LT_PERCENT_PERCENT),
	56:  uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	57:  uint16(anon_sym_LT_PERCENT_POUND),
	58:  uint16(anon_sym_LT_PERCENT_BANG_DASH_DASH),
	59:  uint16(sym_text),
	60:  uint16(2),
	61:  uint16(51),
	62:  uint16(1),
	64:  uint16(53),
	65:  uint16(7),
	66:  uint16(anon_sym_LT_PERCENT),
	67:  uint16(anon_sym_LT_PERCENT_EQ),
	68:  uint16(anon_sym_LT_PERCENT_PERCENT),
	69:  uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	70:  uint16(anon_sym_LT_PERCENT_POUND),
	71:  uint16(anon_sym_LT_PERCENT_BANG_DASH_DASH),
	72:  uint16(sym_text),
	73:  uint16(2),
	74:  uint16(55),
	75:  uint16(1),
	77:  uint16(57),
	78:  uint16(7),
	79:  uint16(anon_sym_LT_PERCENT),
	80:  uint16(anon_sym_LT_PERCENT_EQ),
	81:  uint16(anon_sym_LT_PERCENT_PERCENT),
	82:  uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	83:  uint16(anon_sym_LT_PERCENT_POUND),
	84:  uint16(anon_sym_LT_PERCENT_BANG_DASH_DASH),
	85:  uint16(sym_text),
	86:  uint16(2),
	87:  uint16(59),
	88:  uint16(1),
	90:  uint16(61),
	91:  uint16(7),
	92:  uint16(anon_sym_LT_PERCENT),
	93:  uint16(anon_sym_LT_PERCENT_EQ),
	94:  uint16(anon_sym_LT_PERCENT_PERCENT),
	95:  uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	96:  uint16(anon_sym_LT_PERCENT_POUND),
	97:  uint16(anon_sym_LT_PERCENT_BANG_DASH_DASH),
	98:  uint16(sym_text),
	99:  uint16(2),
	100: uint16(63),
	101: uint16(1),
	103: uint16(65),
	104: uint16(7),
	105: uint16(anon_sym_LT_PERCENT),
	106: uint16(anon_sym_LT_PERCENT_EQ),
	107: uint16(anon_sym_LT_PERCENT_PERCENT),
	108: uint16(anon_sym_LT_PERCENT_PERCENT_EQ),
	109: uint16(anon_sym_LT_PERCENT_POUND),
	110: uint16(anon_sym_LT_PERCENT_BANG_DASH_DASH),
	111: uint16(sym_text),
	112: uint16(3),
	113: uint16(69),
	114: uint16(1),
	115: uint16(sym__code),
	116: uint16(12),
	117: uint16(1),
	118: uint16(aux_sym_partial_expression_repeat1),
	119: uint16(67),
	120: uint16(3),
	121: uint16(anon_sym_PERCENT_GT),
	122: uint16(anon_sym_do),
	123: uint16(anon_sym_DASH_GT),
	124: uint16(4),
	125: uint16(72),
	126: uint16(1),
	127: uint16(anon_sym_PERCENT_GT),
	128: uint16(76),
	129: uint16(1),
	130: uint16(sym__code),
	131: uint16(12),
	132: uint16(1),
	133: uint16(aux_sym_partial_expression_repeat1),
	134: uint16(74),
	135: uint16(2),
	136: uint16(anon_sym_do),
	137: uint16(anon_sym_DASH_GT),
	138: uint16(3),
	139: uint16(78),
	140: uint16(1),
	141: uint16(anon_sym_PERCENT_GT),
	142: uint16(80),
	143: uint16(1),
	144: uint16(sym__code),
	145: uint16(25),
	146: uint16(1),
	147: uint16(aux_sym_partial_expression_repeat1),
	148: uint16(3),
	149: uint16(82),
	150: uint16(1),
	151: uint16(anon_sym_PERCENT_GT),
	152: uint16(84),
	153: uint16(1),
	154: uint16(sym__code),
	155: uint16(14),
	156: uint16(1),
	157: uint16(aux_sym_partial_expression_repeat1),
	158: uint16(3),
	159: uint16(86),
	160: uint16(1),
	161: uint16(aux_sym__bang_comment_token1),
	162: uint16(88),
	163: uint16(1),
	164: uint16(anon_sym_DASH_DASH_PERCENT_GT),
	165: uint16(21),
	166: uint16(1),
	167: uint16(aux_sym__bang_comment_repeat1),
	168: uint16(3),
	169: uint16(80),
	170: uint16(1),
	171: uint16(sym__code),
	172: uint16(90),
	173: uint16(1),
	174: uint16(anon_sym_PERCENT_GT),
	175: uint16(25),
	176: uint16(1),
	177: uint16(aux_sym_partial_expression_repeat1),
	178: uint16(3),
	179: uint16(90),
	180: uint16(1),
	181: uint16(anon_sym_PERCENT_GT),
	182: uint16(92),
	183: uint16(1),
	184: uint16(sym__code),
	185: uint16(22),
	186: uint16(1),
	187: uint16(aux_sym_partial_expression_repeat1),
	188: uint16(3),
	189: uint16(94),
	190: uint16(1),
	191: uint16(anon_sym_PERCENT_GT),
	192: uint16(96),
	193: uint16(1),
	194: uint16(sym__code),
	195: uint16(17),
	196: uint16(1),
	197: uint16(aux_sym_partial_expression_repeat1),
	198: uint16(3),
	199: uint16(98),
	200: uint16(1),
	201: uint16(aux_sym__bang_comment_token1),
	202: uint16(100),
	203: uint16(1),
	204: uint16(anon_sym_DASH_DASH_PERCENT_GT),
	205: uint16(16),
	206: uint16(1),
	207: uint16(aux_sym__bang_comment_repeat1),
	208: uint16(3),
	209: uint16(102),
	210: uint16(1),
	211: uint16(aux_sym__bang_comment_token1),
	212: uint16(105),
	213: uint16(1),
	214: uint16(anon_sym_DASH_DASH_PERCENT_GT),
	215: uint16(21),
	216: uint16(1),
	217: uint16(aux_sym__bang_comment_repeat1),
	218: uint16(3),
	219: uint16(80),
	220: uint16(1),
	221: uint16(sym__code),
	222: uint16(107),
	223: uint16(1),
	224: uint16(anon_sym_PERCENT_GT),
	225: uint16(25),
	226: uint16(1),
	227: uint16(aux_sym_partial_expression_repeat1),
	228: uint16(3),
	229: uint16(107),
	230: uint16(1),
	231: uint16(anon_sym_PERCENT_GT),
	232: uint16(109),
	233: uint16(1),
	234: uint16(sym__code),
	235: uint16(24),
	236: uint16(1),
	237: uint16(aux_sym_partial_expression_repeat1),
	238: uint16(3),
	239: uint16(80),
	240: uint16(1),
	241: uint16(sym__code),
	242: uint16(111),
	243: uint16(1),
	244: uint16(anon_sym_PERCENT_GT),
	245: uint16(25),
	246: uint16(1),
	247: uint16(aux_sym_partial_expression_repeat1),
	248: uint16(3),
	249: uint16(67),
	250: uint16(1),
	251: uint16(anon_sym_PERCENT_GT),
	252: uint16(113),
	253: uint16(1),
	254: uint16(sym__code),
	255: uint16(25),
	256: uint16(1),
	257: uint16(aux_sym_partial_expression_repeat1),
	258: uint16(2),
	259: uint16(116),
	260: uint16(1),
	261: uint16(anon_sym_PERCENT_GT),
	262: uint16(118),
	263: uint16(1),
	264: uint16(anon_sym_POUND),
	265: uint16(2),
	266: uint16(120),
	267: uint16(1),
	268: uint16(anon_sym_PERCENT_GT),
	269: uint16(122),
	270: uint16(1),
	271: uint16(anon_sym_POUND),
	272: uint16(1),
	273: uint16(124),
	274: uint16(1),
	275: uint16(anon_sym_PERCENT_GT),
	276: uint16(1),
	277: uint16(126),
	278: uint16(1),
}

var ts_small_parse_table_map = [26]uint32_t{
	1:  uint32(21),
	2:  uint32(34),
	3:  uint32(47),
	4:  uint32(60),
...
var ts_parse_actions = [128]TSParseActionEntry{
	0: {},
	...
	68: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Ftype_token:  uint8(TSParseActionTypeReduce),
		Fchild_count: uint8(2),
		Fsymbol:      uint16(aux_sym_partial_expression_repeat1),
	})))),
	...
	91: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Ftype_token:  uint8(TSParseActionTypeReduce),
		Fchild_count: uint8(2),
		Fsymbol:      uint16(sym_partial_expression),
	})))),
	...
	103: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Ftype_token:  uint8(TSParseActionTypeReduce),
		Fchild_count: uint8(2),
		Fsymbol:      uint16(aux_sym__bang_comment_repeat1),
	})))),
...
func tree_sitter_eex(tls *libc.TLS) (r uintptr) {
...
var __ccgo_ts1 = "end\x00<%\x00<%=\x00<%%\x00<%%=\x00%>\x00partial_expression_token1\x00do\x00->\x00#\x00<%#\x00<%!--\x00_bang_comment_token1\x00--%>\x00text\x00_code\x00fragment\x00_node\x00directive\x00partial_expression\x00expression\x00comment\x00_hash_comment\x00_bang_comment\x00fragment_repeat1\x00partial_expression_repeat1\x00_bang_comment_repeat1\x00"
