...
func tree_sitter_wgsl_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	var v4 uint64
	_, _, _, _, _, _, _ = comment_depth, v1, v3, v4, v5, v7, v8
	for {
