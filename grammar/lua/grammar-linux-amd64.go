// Code generated for linux/amd64 by 'ccgo /tmp/grammar-gen-3701974371/preprocessed.c -o /tmp/grammar-gen-3701974371/grammar.go', DO NOT EDIT.
...
start:
	...
	case 0:
		...
		for {
			...
			if libc.Int32FromUint16(map7[i]) == lookahead {
				state = map7[i+uint32(1)]
				goto next_state
			}
			goto _1
		_1:
