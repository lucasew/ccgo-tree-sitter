// Code generated for linux/arm64 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions -std=gnu11 -O0 -Dfunc=func_token -Dinterface=interface_token -Dselect=select_token -Dchan=chan_token -Dgo=go_token -Dmap=map_token -Dpackage=package_token -Dtype=type_token -Dvar=var_token -Dimport=import_token -Ddefer=defer_token -Dfallthrough=fallthrough_token -Drange=range_token -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-wit/src -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-wit -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/include -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/src combined.c -o grammar.go', DO NOT EDIT.
...
func process_left_forward_slash(tls *libc.TLS, processing uintptr, current uint8) {
	if libc.Int32FromUint8(current) == int32('*') {
		*(*uint32)(unsafe.Pointer(processing + 4)) += uint32(1)
	}
	(*BlockCommentProcessing)(unsafe.Pointer(processing)).Fstate = int32(Continuing)
}

func process_left_asterisk(tls *libc.TLS, processing uintptr, current uint8, lexer uintptr) {
	if libc.Int32FromUint8(current) == int32('*') {
...
func process_continuing(tls *libc.TLS, processing uintptr, current uint8) {
	switch libc.Int32FromUint8(current) {
	case int32('/'):
...
func process_block_comment(tls *libc.TLS, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	first = libc.Uint8FromInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead)
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(BLOCK_DOC_MARKER))) != 0 && libc.Int32FromUint8(first) == int32('*') {
		advance(tls, lexer)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(BLOCK_COMMENT_CONTENT))) != 0 {
		*(*BlockCommentProcessing)(unsafe.Pointer(bp)) = BlockCommentProcessing{
		...
		switch libc.Int32FromUint8(first) {
		case int32('*'):
		...
		for !((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0) && (*(*BlockCommentProcessing)(unsafe.Pointer(bp))).FnestingDepth != uint32(0) {
			...
			advance(tls, lexer)
			if libc.Int32FromUint8(first) == int32('/') && (*(*BlockCommentProcessing)(unsafe.Pointer(bp))).FnestingDepth != uint32(0) {
				(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
			}
		}
