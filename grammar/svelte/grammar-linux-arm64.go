// Code generated for linux/arm64 by 'ccgo /tmp/grammar-gen-964646085/preprocessed.c -o /tmp/grammar-gen-964646085/grammar.go', DO NOT EDIT.
	...
	for {
		...
		_ = libc.Uint64FromInt64(4)
		{
			if !(i < (*struct {
				...
				libc.X__assert_fail(tls, __ccgo_ts+215, __ccgo_ts+160, int32(705), uintptr(unsafe.Pointer(&__func__5)))
			}
		}
		tag_free(tls, (*struct {
			Fcontents uintptr
