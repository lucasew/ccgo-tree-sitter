// Code generated for linux/386 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions -std=gnu11 -O0 -Dfunc=func_token -Dinterface=interface_token -Dselect=select_token -Dchan=chan_token -Dgo=go_token -Dmap=map_token -Dpackage=package_token -Dtype=type_token -Dvar=var_token -Dimport=import_token -Ddefer=defer_token -Dfallthrough=fallthrough_token -Drange=range_token -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-printf/src -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-printf -I /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/include -I /home/runner/.cache/workspaced/sources/github/7349d53bdd4ab31f79a3eec0385f924117fa6d06f018e00aadd823c0dcd51ac2/lib/src /home/runner/work/ccgo-tree-sitter/ccgo-tree-sitter/third-party/tree-sitter-printf/src/parser.c -o grammar.go', DO NOT EDIT.
...
const anon_sym_PERCENT_PERCENT = 1
const anon_sym_PERCENT = 2
const sym_type = 3
const sym_flags = 4
const sym_width = 5
const sym_precision = 6
const sym_size = 7
const aux_sym__text_token1 = 8
const sym_format_string = 9
const sym_format = 10
const sym__text = 11
const aux_sym_format_string_repeat1 = 12

var ts_symbol_names = [13]uintptr{
	0:  __ccgo_ts,
	1:  __ccgo_ts + 4,
	2:  __ccgo_ts + 7,
	3:  __ccgo_ts + 9,
...
var ts_symbol_map = [13]TSSymbol{
	1:  uint16(anon_sym_PERCENT_PERCENT),
	2:  uint16(anon_sym_PERCENT),
	3:  uint16(sym_type),
	4:  uint16(sym_flags),
	5:  uint16(sym_width),
	6:  uint16(sym_precision),
	7:  uint16(sym_size),
	8:  uint16(aux_sym__text_token1),
	9:  uint16(sym_format_string),
	10: uint16(sym_format),
	11: uint16(sym__text),
	12: uint16(aux_sym_format_string_repeat1),
}
...
var ts_primary_state_ids = [21]TSStateId{
	1:  uint16(1),
	2:  uint16(2),
	3:  uint16(3),
	4:  uint16(4),
...
start:
	...
	case 0:
		...
		i = uint32(0)
		for {
			if !(i < libc.Uint32FromInt64(48)/libc.Uint32FromInt64(2)) {
				break
			}
		...
		if int32('A') <= lookahead && lookahead <= int32('Z') || int32('a') <= lookahead && lookahead <= int32('y') {
			state = uint16(9)
			goto next_state
		}
		return result
	case int32(1):
		i1 = uint32(0)
		for {
			if !(i1 < libc.Uint32FromInt64(64)/libc.Uint32FromInt64(2)) {
				break
			}
		...
		if int32('\t') <= lookahead && lookahead <= int32('\r') {
			skip = libc.BoolUint8(true1 != 0)
			state = uint16(1)
			goto next_state
		}
	...
	case int32(9):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(sym_type)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		return result
	case int32(10):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(sym_flags)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		return result
	case int32(11):
		result = libc.BoolUint8(true1 != 0)
	...
	case int32(13):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(sym_width)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		return result
	case int32(14):
		result = libc.BoolUint8(true1 != 0)
	...
	case int32(15):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(sym_precision)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		return result
	case int32(16):
		result = libc.BoolUint8(true1 != 0)
	...
	case int32(18):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(sym_size)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		return result
	case int32(19):
		result = libc.BoolUint8(true1 != 0)
...
var ts_parse_table = [4][13]uint16_t{
	0: {
		0: uint16(1),
		1: uint16(1),
		2: uint16(1),
...
var ts_small_parse_table = [135]uint16_t{
	0:   uint16(5),
	1:   uint16(28),
	2:   uint16(1),
	3:   uint16(sym_type),
	...
	30:  uint16(46),
	31:  uint16(2),
	33:  uint16(aux_sym__text_token1),
	34:  uint16(48),
	35:  uint16(2),
	36:  uint16(anon_sym_PERCENT_PERCENT),
	37:  uint16(anon_sym_PERCENT),
	38:  uint16(2),
	39:  uint16(50),
	40:  uint16(2),
	42:  uint16(aux_sym__text_token1),
	43:  uint16(52),
	44:  uint16(2),
	45:  uint16(anon_sym_PERCENT_PERCENT),
	46:  uint16(anon_sym_PERCENT),
	47:  uint16(2),
	48:  uint16(54),
	49:  uint16(2),
	51:  uint16(aux_sym__text_token1),
	52:  uint16(56),
	53:  uint16(2),
	54:  uint16(anon_sym_PERCENT_PERCENT),
	55:  uint16(anon_sym_PERCENT),
	56:  uint16(2),
	57:  uint16(58),
	58:  uint16(2),
	60:  uint16(aux_sym__text_token1),
	61:  uint16(60),
	62:  uint16(2),
	63:  uint16(anon_sym_PERCENT_PERCENT),
	64:  uint16(anon_sym_PERCENT),
	65:  uint16(2),
	66:  uint16(62),
	67:  uint16(2),
	69:  uint16(aux_sym__text_token1),
	70:  uint16(64),
	71:  uint16(2),
	72:  uint16(anon_sym_PERCENT_PERCENT),
	73:  uint16(anon_sym_PERCENT),
	74:  uint16(3),
	75:  uint16(38),
	76:  uint16(1),
	77:  uint16(sym_type),
...
var ts_small_parse_table_map = [17]uint32_t{
	1:  uint32(16),
	2:  uint32(29),
	3:  uint32(38),
	4:  uint32(47),
...
var ts_parse_actions = [86]TSParseActionEntry{
	0: {},
	...
	4: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Fsymbol:     uint16(sym_format_string),
	})))),
	...
	18: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Fsymbol:      uint16(aux_sym_format_string_repeat1),
	})))),
...
func tree_sitter_printf(tls *libc.TLS) (r uintptr) {
...
var __ccgo_ts1 = "end\x00%%\x00%\x00type\x00flags\x00width\x00precision\x00size\x00_text_token1\x00format_string\x00format\x00_text\x00format_string_repeat1\x00"
