...
func scan_pi_target(tls *libc.TLS, lexer2 uintptr, valid_symbols uintptr) (r uint8) {
	...
	v1 = libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer2)).Flookahead)
	v2 = libc.BoolUint8(libc.Xiswalpha(tls, v1) != 0 || v1 == uint32('_') || v1 == uint32(':'))
	goto _3
_3:
	if v2 != 0 {
	...
	if advanced_once != 0 {
		for {
			v1 = libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer2)).Flookahead)
			v2 = libc.BoolUint8(libc.Xiswalnum(tls, v1) != 0 || v1 == uint32('_') || v1 == uint32(':') || v1 == uint32('.') || v1 == uint32('-') || v1 == uint32(0xB7))
			goto _7
		_7:
			if !(v2 != 0) {
				break
						...
						if last_char_hyphen != 0 {
							if v19 = *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(XML_MODEL))) != 0; v19 {
								...
								for {
									...
									if !((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(v4)).Feof})))(tls, v4) != 0) && (*TSLexer)(unsafe.Pointer(v4)).Flookahead == libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(__ccgo_ts + uintptr(j)))) {
										v8 = v4
							...
							if v19 = *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(XML_STYLESHEET))) != 0; v19 {
								...
								for {
									...
									if !((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(v4)).Feof})))(tls, v4) != 0) && (*TSLexer)(unsafe.Pointer(v4)).Flookahead == libc.Int32FromUint8(*(*uint8)(unsafe.Pointer(__ccgo_ts + 6 + uintptr(j)))) {
										v8 = v4
										(*(*func(*libc.TLS, uintptr, uint8))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(v8)).Fadvance})))(tls, v8, libc.BoolUint8(false1 != 0))
									} else {
										v2 = libc.BoolUint8(false1 != 0)
...
func scan_tag_name(tls *libc.TLS, lexer1 uintptr) (r String) {
	...
	*(*String)(unsafe.Pointer(bp)) = String{}
	v1 = libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer1)).Flookahead)
	v2 = libc.BoolUint8(libc.Xiswalpha(tls, v1) != 0 || v1 == uint32('_') || v1 == uint32(':'))
	goto _3
_3:
	if v2 != 0 {
		...
		*(*uint8)(unsafe.Pointer((*String)(unsafe.Pointer(bp)).Fcontents + uintptr(v8))) = libc.Uint8FromInt32((*TSLexer)(unsafe.Pointer(lexer1)).Flookahead)
		v4 = lexer1
		(*(*func(*libc.TLS, uintptr, uint8))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(v4)).Fadvance})))(tls, v4, libc.BoolUint8(false1 != 0))
	}
	for {
...
var __func__1 = [18]uint8{'s', 'c', 'a', 'n', '_', 'e', 'n', 'd', '_', 't', 'a', 'g', '_', 'n', 'a', 'm', 'e'}
...
var __func__11 = [41]uint8{'t', 'r', 'e', 'e', '_', 's', 'i', 't', 't', 'e', 'r', '_', 'x', 'm', 'l', '_', 'e', 'x', 't', 'e', 'r', 'n', 'a', 'l', '_', 's', 'c', 'a', 'n', 'n', 'e', 'r', '_', 'd', 'e', 's', 't', 'r', 'o', 'y'}
...
func tree_sitter_xml_external_scanner_serialize(tls *libc.TLS, payload uintptr, buffer uintptr) (r uint32) {
	...
	*(*uint32_t)(unsafe.Pointer(bp + 4)) = uint32(0)
	...
	for {
		...
		v4 = size
		size = size + 1
		*(*uint8)(unsafe.Pointer(buffer + uintptr(v4))) = uint8(name_length)
...
var __func__12 = [43]uint8{'t', 'r', 'e', 'e', '_', 's', 'i', 't', 't', 'e', 'r', '_', 'x', 'm', 'l', '_', 'e', 'x', 't', 'e', 'r', 'n', 'a', 'l', '_', 's', 'c', 'a', 'n', 'n', 'e', 'r', '_', 's', 'e', 'r', 'i', 'a', 'l', 'i', 'z', 'e'}
	...
	*(*uint32_t)(unsafe.Pointer(bp + 4)) = uint32(0)
	...
	for {
		...
		*(*String)(unsafe.Pointer(bp + 8)) = String{}
		v6 = size
		size = size + 1
		(*(*String)(unsafe.Pointer(bp + 8))).Fsize = uint32(*(*uint8)(unsafe.Pointer(buffer + uintptr(v6))))
...
var __func__3 = [45]uint8{'t', 'r', 'e', 'e', '_', 's', 'i', 't', 't', 'e', 'r', '_', 'x', 'm', 'l', '_', 'e', 'x', 't', 'e', 'r', 'n', 'a', 'l', '_', 's', 'c', 'a', 'n', 'n', 'e', 'r', '_', 'd', 'e', 's', 'e', 'r', 'i', 'a', 'l', 'i', 'z', 'e'}
