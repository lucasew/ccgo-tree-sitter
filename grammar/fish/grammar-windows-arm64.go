...
func tree_sitter_fish_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(BEGIN_BRACE))) != 0 {
		...
		if (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('{') {
			...
			if (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(';') || libc.Xiswctype(tls, uint16((*TSLexer)(unsafe.Pointer(lexer)).Flookahead), uint16(_SPACE)) != 0 {
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(CONCAT))) != 0 {
		if !((*TSLexer)(unsafe.Pointer(lexer)).Flookahead == 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('>') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('<') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(')') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(';') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('&') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('|') || libc.Xiswctype(tls, uint16((*TSLexer)(unsafe.Pointer(lexer)).Flookahead), uint16(_SPACE)) != 0) {
			(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(CONCAT)
			return libc.BoolUint8(true1 != 0)
		}
	}
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(BRACKET_CONCAT))) != 0 {
		if !((*TSLexer)(unsafe.Pointer(lexer)).Flookahead == 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(')') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('(') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('}') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(',') || libc.Xiswctype(tls, uint16((*TSLexer)(unsafe.Pointer(lexer)).Flookahead), uint16(_SPACE)) != 0) {
