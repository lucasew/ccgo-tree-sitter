...
func scan(tls *libc.TLS, lexer uintptr, scanner uintptr, chr uint8, symbol int32) (r uint8) {
	var length uint32_t
	_ = length
	length = uint32(0)
	for {
		if !(!((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0) && (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == libc.Int32FromUint8(chr)) {
			break
		}
		advance(tls, lexer)
		goto _1
	...
	for {
		...
		if symbol == int32(EQUALS_BEGIN) && !((*Scanner)(unsafe.Pointer(scanner)).Finitialized != 0) {
			(*Scanner)(unsafe.Pointer(scanner)).Fsuffix = libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead)
		}
		if (*Scanner)(unsafe.Pointer(scanner)).Fsuffix != libc.Uint32FromInt32((*TSLexer)(unsafe.Pointer(lexer)).Flookahead) {
			return libc.BoolUint8(false1 != 0)
		}
		advance(tls, lexer)
		goto _2
...
func tree_sitter_test_external_scanner_create(tls *libc.TLS) (r uintptr) {
	...
	(*Scanner)(unsafe.Pointer(scanner)).Fsuffix = uint32('\000')
...
func tree_sitter_test_external_scanner_serialize(tls *libc.TLS, payload uintptr, buffer uintptr) (r uint32) {
	...
	libc.Xmemset(tls, buffer, int32(true1), uint64(1))
	libc.Xmemset(tls, buffer+uintptr(1), libc.Int32FromUint32((*Scanner)(unsafe.Pointer(scanner)).Fsuffix), uint64((*Scanner)(unsafe.Pointer(scanner)).Flength))
...
func tree_sitter_test_external_scanner_deserialize(tls *libc.TLS, payload uintptr, buffer uintptr, length uint32_t) {
	...
	(*Scanner)(unsafe.Pointer(scanner)).Fsuffix = uint32(*(*uint8)(unsafe.Pointer(buffer + 1)))
	(*Scanner)(unsafe.Pointer(scanner)).Finitialized = uint8(libc.BoolUint8(*(*uint8)(unsafe.Pointer(buffer)) != 0))
}
...
func tree_sitter_test_external_scanner_scan(tls *libc.TLS, payload uintptr, lexer uintptr, valid_symbols uintptr) (r uint8) {
	...
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(EQUALS_BEGIN))) != 0 {
		return scan(tls, lexer, scanner, uint8('='), int32(EQUALS_BEGIN))
	}
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(EQUALS_END))) != 0 {
		return scan(tls, lexer, scanner, uint8('='), int32(EQUALS_END))
	}
	if *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(DASHES))) != 0 {
		return scan(tls, lexer, scanner, uint8('-'), int32(DASHES))
	}
	return libc.BoolUint8(false1 != 0)
}
