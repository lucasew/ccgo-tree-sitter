...
const anon_sym_LF = 1
const anon_sym_classname = 2
const anon_sym_depends = 3
const anon_sym_designersupported = 4
const anon_sym_internal = 5
const anon_sym_linktarget = 6
const anon_sym_module = 7
const anon_sym_optional = 8
const anon_sym_plugin = 9
const anon_sym_prefer = 10
const anon_sym_singleton = 11
const anon_sym_typeinfo = 12
const sym_identifier = 13
const sym_unit = 14
const sym_number = 15
const sym_float = 16
const sym_comment = 17
const sym_module_definition = 18
const sym_command = 19
const sym_keyword = 20
const aux_sym_module_definition_repeat1 = 21
const aux_sym_command_repeat1 = 22

var ts_symbol_names = [23]uintptr{
	0:  __ccgo_ts,
	1:  __ccgo_ts + 4,
	2:  __ccgo_ts + 6,
	3:  __ccgo_ts + 16,
...
var ts_symbol_map = [23]TSSymbol{
	1:  uint16(anon_sym_LF),
	2:  uint16(anon_sym_classname),
	3:  uint16(anon_sym_depends),
	4:  uint16(anon_sym_designersupported),
	5:  uint16(anon_sym_internal),
	6:  uint16(anon_sym_linktarget),
	7:  uint16(anon_sym_module),
	8:  uint16(anon_sym_optional),
	9:  uint16(anon_sym_plugin),
	10: uint16(anon_sym_prefer),
	11: uint16(anon_sym_singleton),
	12: uint16(anon_sym_typeinfo),
	13: uint16(sym_identifier),
	14: uint16(sym_unit),
	15: uint16(sym_number),
	16: uint16(sym_float),
	17: uint16(sym_comment),
	18: uint16(sym_module_definition),
	19: uint16(sym_command),
	20: uint16(sym_keyword),
	21: uint16(aux_sym_module_definition_repeat1),
	22: uint16(aux_sym_command_repeat1),
}

var ts_symbol_metadata = [23]TSSymbolMetadata{
	0: {
...
var ts_primary_state_ids = [11]TSStateId{
	1:  uint16(1),
	2:  uint16(2),
	3:  uint16(3),
	4:  uint16(4),
...
start:
	...
	case int32(6):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_classname)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
	...
	case int32(7):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_depends)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(8):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_designersupported)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(9):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_internal)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(10):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_linktarget)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(13):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_plugin)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(14):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_prefer)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(15):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_singleton)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(16):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(anon_sym_typeinfo)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') || int32('A') <= lookahead && lookahead <= int32('Z') || lookahead == int32('_') || int32('a') <= lookahead && lookahead <= int32('z') {
			state = uint16(97)
			goto next_state
	...
	case int32(98):
		result = libc.BoolUint8(true1 != 0)
		(*TSLexer)(unsafe.Pointer(lexer)).Fresult_symbol = uint16(sym_unit)
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
		if int32('0') <= lookahead && lookahead <= int32('9') {
			state = uint16(98)
			goto next_state
...
var ts_lex_modes = [11]TSLexerMode{
	0: {},
	1: {},
	2: {},
	3: {},
...
var ts_parse_table = [6][23]uint16_t{
	0: {
		0:  uint16(1),
		2:  uint16(1),
		3:  uint16(1),
...
var ts_small_parse_table = [64]uint16_t{
	0:  uint16(4),
	1:  uint16(29),
	2:  uint16(1),
	3:  uint16(anon_sym_LF),
	4:  uint16(33),
	5:  uint16(1),
	6:  uint16(sym_comment),
	7:  uint16(7),
	8:  uint16(1),
	9:  uint16(aux_sym_command_repeat1),
	10: uint16(31),
	11: uint16(3),
	12: uint16(sym_unit),
	...
	19: uint16(35),
	20: uint16(1),
	21: uint16(anon_sym_LF),
	22: uint16(8),
	23: uint16(1),
	24: uint16(aux_sym_command_repeat1),
	25: uint16(37),
	26: uint16(3),
	27: uint16(sym_unit),
	28: uint16(sym_number),
	29: uint16(sym_float),
	30: uint16(4),
	31: uint16(33),
	32: uint16(1),
	33: uint16(sym_comment),
	34: uint16(39),
	35: uint16(1),
	36: uint16(anon_sym_LF),
	37: uint16(8),
	38: uint16(1),
	39: uint16(aux_sym_command_repeat1),
	40: uint16(41),
	41: uint16(3),
	42: uint16(sym_unit),
...
var ts_small_parse_table_map = [5]uint32_t{
	1: uint32(15),
	2: uint32(30),
	3: uint32(45),
	4: uint32(57),
...
var ts_parse_actions = [50]TSParseActionEntry{
	0: {},
	...
	6: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Fsymbol:     uint16(sym_module_definition),
	})))),
	...
	14: *(*TSParseActionEntry)(unsafe.Pointer(&*(*TSParseAction)(unsafe.Pointer(&struct {
		...
		Fsymbol:      uint16(aux_sym_module_definition_repeat1),
	})))),
...
func tree_sitter_qmldir(tls *libc.TLS) (r uintptr) {
...
var __ccgo_ts1 = "end\x00\n\x00classname\x00depends\x00designersupported\x00internal\x00linktarget\x00module\x00optional\x00plugin\x00prefer\x00singleton\x00typeinfo\x00identifier\x00unit\x00number\x00float\x00comment\x00module_definition\x00command\x00keyword\x00module_definition_repeat1\x00command_repeat1\x00qmldir\x00"
